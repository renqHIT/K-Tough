...
/*
class ToughTest extends SparkTestUtils with ShouldMatchers{
  ...
  "return 1/(n-1) when calculating a star graph" in
  {
    ...
    //val star = Graph(sc.parallelize(List((0L,1), (1L,1), (2L,1), (3L,1), (4L,1), (5L,1))), sc.parallelize(List(Edge(0L,1L,1), Edge(0L,2L,1), Edge(0L,3L,1), Edge(0L,4L,1), Edge(0L,5L,1)), 5))
    //calculator.toughness(star) should be (0.2)
  }
